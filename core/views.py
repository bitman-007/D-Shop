            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    if shipping_address_qs.exists():
                        ...
                        messages.info(
                            self.request, 'you do not have default shipping address')
                        return redirect('core:checkout')
                else:
                    # named it shipping_address1 because of the conflict with shipping_address in if statment apove
                    ...
                    if is_valid_form([shipping_address1, shipping_country, shipping_zip]):
                        ...
                        messages.info(self.request, 'fill in the fields')
                        return redirect('core:checkout')

                use_default_billing = form.cleaned_data.get(
                    'use_default_billing')

                same_as_shipping_address = form.cleaned_data.get(
                ...
                if same_as_shipping_address:
                    ...
                    if billing_address_qs.exists():
                        ...
                        messages.info(
                            self.request, 'you do not have default billing address')
                        return redirect('core:checkout')
                else:
                    # named it billing_address1 because of the conflict with billing_address in if statment apove
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            # yourself an email
            messages.warning(self.request, "that's bad")
            return redirect('/')
        except Exception as e:
            # Something else happened, completely unrelated to Stripe
            messages.warning(self.request, "this is serious !!")
            return redirect('/')
...
def remove_from_cart(request, slug):
    ...
    if order_qs.exists():
        ...
        messages.info(request, "This isn't an active order")
        return redirect("core:product", slug=slug)
